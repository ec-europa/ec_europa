...
<?php if (!$is_empty) : ?>
  ...
  <div class="<?php print $wrapper_classes; ?>">
    ...
    <?php if ($flip) : ?>
      <div class="tab-content <?php print $pane_classes; ?>">
        <?php foreach ($panes as $index => $pane) : ?>
          <div id="<?php print $pane['id']; ?>" class="tab-pane <?php if ($index === $active) : print 'active'; endif; ?>">
    ...
    <?php if (!$is_single) : ?>
      <ul class="nav<?php print $nav_classes; ?>">
        <?php foreach ($navs as $index => $nav) : ?>
          <li class="<?php if ($index === $active) : print 'active'; endif; ?>">
    ...
    <?php if (!$flip) : ?>
      <div class="tab-content <?php print $pane_classes; ?>">
        <?php foreach ($panes as $index => $pane) : ?>
          <div id="<?php print $pane['id']; ?>" class="<?php if ($index === $active) : print 'active'; endif; ?>">
