    ...
    <?php for ($cursor = $pager_first; $cursor <= $pager_last; $cursor++): ?>
      ...
      <?php else: ?>
        <li class="ecl-pager__item">
          <a class="ecl-pager__link" title="<?php print $goto_title ?> <?php print $links['pager_link__' . $cursor]['label'] ?>" href="<?php print $links['pager_link__' . $cursor]['url'] ?>">
            <?php print $links['pager_link__' . $cursor]['label'] ?>
          </a>
        </li>
      <?php endif ?>
